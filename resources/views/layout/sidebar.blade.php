...
<div class="d-flex  sticky-left flex-column flex-shrink-0 p-3 text-dark" style="width:100% !important;margin:0;">
   
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="{{route('home')}}" class="nav-link text-dark {{ request()->routeIs('home') ? 'active' : '' }}" aria-current="page">
        <svg class="bi me-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-door" viewBox="0 0 16 16">
